assert('add_breakpoint') do
  mrb_bp = MrubyBreakpoint.new('ruby_gdb.c', 89)
  mrb_bp.add_breakpoint('foo.rb', { 'line' => 10 })
  assert_equal 1, mrb_bp.c_breakpoints['breakpoints'].size
  assert_equal 89, mrb_bp.c_breakpoints['breakpoints'][0]['line']
  ...
  assert_equal 89, mrb_bp.c_breakpoints['breakpoints'][1]['line']
  ...
  assert_equal 89, mrb_bp.c_breakpoints['breakpoints'][2]['line']
